        ...
        <div class="col-md-6">
            ...
            <div class="card">
                <div class="card-header">
                    <h4>
                        <a href="{{ url('designForm') }}" class="btn btn-danger float-end">BACK</a>
                    </h4>
                </div>
                <div class="card-body">
                    <form action="{{ url('add-designForm') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="city" class="form-control" accept="image/*">
                        </div>
