        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4> عرض طلبات المواقع الالكترونية
                    </h4>
                    <a href="{{ url('add-webForm') }}" class="btn btn-primary float-end">أضف جديد</a>
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $item->budget }}</td>
                                <td>
                                    <a href="{{ url('view-webForm/'.$item->id) }}" class="btn btn-primary btn-sm">عرض كل البيانات</a>
                                </td>
                         
                                <td dir="ltr">

                                  <form action="{{url('webform_status_upadated/'.$item->id)}}" method="POST">
                                ...
                                <td>
                                    ...
                                    <form action="{{ url('delete-webForm/'.$item->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
