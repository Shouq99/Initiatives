        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{ url('add-tech_supportform') }}" class="btn btn-primary float-end">أضف جديد</a>
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $item->budget }}</td>
                                <td>
                                    <a href="{{ url('view-tech_supportform/'.$item->id) }}" class="btn btn-primary btn-sm">عرض كل البيانات</a>
                                </td>
                            
                                <td dir="ltr">

                                  <form action="{{url('tech_supportform_status_upadated/'.$item->id)}}" method="POST">
                                ...
                                <td>
                                    ...
                                    <form action="{{ url('delete-tech_supportform/'.$item->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
