        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{ url('add-appForm') }}" class="btn btn-primary float-end">أضف جديد</a>
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $item->budget }}</td>
                                <td>
                                    <a href="{{ url('view-appForm/'.$item->id) }}" class="btn btn-primary btn-sm">عرض كل البيانات</a>
                                </td>
                                ...
                                <td>
                                    ...
                                    <form action="{{ url('delete-appForm/'.$item->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
