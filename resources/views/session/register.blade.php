...
<section class="min-vh-100 mb-8" dir="rtl">
  <div class="align-items-start min-vh-50 pt-5 pb-11 mx-3 border-radius-lg">
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-5 text-center mx-auto">
          <h1 class="text-white mb-2 mt-5 text-gradient text_header_signin">أهلا وسهلا</h1>
      ...
      <div class="col-xl-4 col-lg-5 col-md-7 mx-auto" >
        <div class="card z-index-0">
          <div class="card-header text-center pt-4">
            <h5>سجل الدخول عن طريق البرامج التالية:</h5>
          </div>
          ...
          <div class="card-body pageDirection">
            <form role="form text-left" method="POST" action="/register">
              @csrf
              <div class="mb-3">
                <input type="text" class="form-control" placeholder="الاسم الكريم" name="name" id="name" aria-label="Name" aria-describedby="name" value="{{ old('name') }}">
                @error('name')
                  <p class="text-danger text-xs mt-2">{{ $message }}</p>
                @enderror
              </div>
              <div class="mb-3">
                <input type="email" class="form-control" placeholder="إيميل" name="email" id="email" aria-label="Email" aria-describedby="email-addon" value="{{ old('email') }}">
                @error('email')
                  <p class="text-danger text-xs mt-2">{{ $message }}</p>
                @enderror
              </div>
              <div class="mb-3">
                <input type="password" class="form-control" placeholder="كلمة السر" name="password" id="password" aria-label="Password" aria-describedby="password-addon">
                @error('password')
                  <p class="text-danger text-xs mt-2">{{ $message }}</p>
                @enderror
              </div>
              <div class="form-check form-check-info text-left" dir="ltr">
                <input class="form-check-input " type="checkbox" name="agreement" id="flexCheckDefault" checked>
                <label class="form-check-label" for="flexCheckDefault">
                  I agree the <a href="javascript:;" class="text-maincontentscolor font-weight-bolder">Terms and Conditions</a>
                </label>
                @error('agreement')
              ...
              <div class="text-center">
                <button type="submit" class="btn btn-gradient btn-txt w-100 my-4 mb-2">إنشاء الحساب</button>
              </div>
              <p class="text-sm mt-3 mb-0 text-maincontentscolor">لديك حساب بالفعل؟ <a href="login" class="text-primarycolor text-gradient font-weight-bolder">سجل دخول من هنا</a></p>
            </form>
