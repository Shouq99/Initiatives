<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-end me-3 rotate-caret " id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}">
        ...
        <span class="ms-1 font-weight-bold">بانوراما القصيم</span>
    </a>
  </div>
  <hr class="horizontal dark mt-0 h-100 d-inline-block">
  <div class="collapse navbar-collapse px-0 w-auto h-100 d-inline-block  max-height-vh-100 h-100" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      <li class="nav-item">
