...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}">
        ...
        <span class="ms-3 font-weight-bold">بانوراما القصيم</span>
    </a>
  </div>
  <hr class="horizontal dark mt-0 h-100 d-inline-block">
  <div class="collapse navbar-collapse h-100 d-inline-block w-auto" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('designForm') ? 'active' : '') }}" href="{{ url('designForm') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <title>عرض طلبات التصميم</title>
              <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
          ...
          <span class="nav-link-text ms-1">طلبات التصميم</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('webForm') ? 'active' : '') }}" href="{{ url('webForm') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <title>عرض طلبات التصميم</title>
              <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
          ...
          <span class="nav-link-text ms-1">طلبات المواقع الالكترونية</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('appForm') ? 'active' : '') }}" href="{{ url('appForm') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <title>عرض طلبات التصميم</title>
              <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
          ...
          <span class="nav-link-text ms-1">طلبات تطبيقات الجوال</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('hostingform') ? 'active' : '') }}" href="{{ url('hostingform') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <title>عرض طلبات الاستضافة</title>
              <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                <g transform="translate(-2319.000000, -291.000000)" fill="#FFFFFF" fill-rule="nonzero">
                  <g transform="translate(1716.000000, 291.000000)">
                    <g transform="translate(603.000000, 0.000000)">
          ...
          <span class="nav-link-text ms-1">طلبات الاستضافة </span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('marketingform') ? 'active' : '') }}" href="{{ url('marketingform') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <title>عرض طلبات التسويق</title>
              <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                <g transform="translate(-2319.000000, -291.000000)" fill="#FFFFFF" fill-rule="nonzero">
                  <g transform="translate(1716.000000, 291.000000)">
                    <g transform="translate(603.000000, 0.000000)">
          ...
          <span class="nav-link-text ms-1">طلبات التسويق </span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('tech_supportform') ? 'active' : '') }}" href="{{ url('tech_supportform') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <title>عرض طلبات دعم الفني</title>
              <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                <g transform="translate(-2319.000000, -291.000000)" fill="#FFFFFF" fill-rule="nonzero">
                  <g transform="translate(1716.000000, 291.000000)">
                    <g transform="translate(603.000000, 0.000000)">
          ...
          <span class="nav-link-text ms-1">طلبات دعم الفني </span>
        </a>
      </li>
      <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('slider') ? 'active' : '') }}" href="{{ url('slider') }}">
          ...
          <span class="nav-link-text ms-1">التحكم بصور السلايدر</span>
        </a>
      </li>
      <li class="nav-item">
